...
require_once dirname(__FILE__) . '/../../includes/lib/userAtuh/MatkonDba.class.php';

class MatkonDbaTest extends UserAtuhTestCase{
    ...
    public function testGetKey($key){
        $db = $this->getMock('PancakeTF_DBAccessI');
        
        $_SESSION['user_atuh'] = $key;
        
        $target = new MatkonDba($db);
    ...
    public function testInsertKey($key){
        ...
        $this->assertEquals($key,$_SESSION['user_atuh']);
    }
